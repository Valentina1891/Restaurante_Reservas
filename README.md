Este es un proyecto de práctica de HTML, CSS y Bootstrap donde se desarrolla una Landing Page para un restaurante, cumpliendo con requisitos de diseño responsive y secciones básicas.
